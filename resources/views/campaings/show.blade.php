                                    ...
                                    @foreach ($contacts as $item)
                                        <tr>
                                            ...
                                            <td class="text-center text-gray-600 text-hover-primary mb-1">
                                                ...
                                                <span class="badge badge-primary pull-rigth text-gray-600">Nuevo</span>
                                                @elseif($item->contact_status == 2)
                                                <span class="badge badge-light-primary pull-rigth text-gray-600">En Negociacion</span>
                                                @elseif($item->contact_status == 3)
                                                <span class="badge badge-primary pull-rigth text-gray-600">Presupuesto Enviado</span>
                                                @elseif($item->contact_status == 4)
                                                <span class="badge badge-light-primary pull-rigth text-gray-600">Cliente</span>
