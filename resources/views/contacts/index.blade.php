                      ...
                      data-target="#exampleModal" type="button">Agrega un contacto</a>
                       ...
                       <li class="nav-item dropdown">
                           ...
                           <div class="dropdown-menu">
                               <a class="dropdown-item menu-link" href="{{ url('admin/pedidos-api') }}">Pedidos
                                   Api</span></a>
                               <a class="dropdown-item menu-link" href="{{ url('admin/clientes-api') }}">Clientes
                                   Api</a>
                               ...
                               <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                   ...
                                   <div class="menu-item px-3">
                                       ...
                                       <div class="menu-item px-5">
                                           <a href="{{ route('admin.usuarios.show', auth()->user()) }}"
                                               class="menu-link px-5" title="Proximamente">Mi perfil </a>
                                       ...
                                       <div class="menu-item px-5 my-1">
                                           <a href="{{ url('admin/config') }}"
                                               class="menu-link px-5">Configuración</a>
                                       </div>
                                       <!--end::Menu item-->
                                       <!--begin::Menu item-->
                                       <div class="menu-item px-5">
                                            ...
                                            data-target="#exampleModal<?= $item->id ?>"></i>
                                                   ...
                                                   <ol class="card__avatars" style="list-style: none">
                                                       <li class="card__avatars--item">
                                                           ...
                                                           @if ($item->image)
                                                               <img src="{{ $item->image }}"
                                                                   alt="{{ $item->name }}" class="avatar__image">
                                                           @else
