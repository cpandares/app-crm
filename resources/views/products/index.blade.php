                    ...
                    <div id="kt_ecommerce_products_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="table-responsive"><table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_ecommerce_products_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0"><th class="w-10px pe-2 sorting_disabled" rowspan="1" colspan="1" aria-label="
                                ...
                                </th><th class="min-w-200px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Product: activate to sort column ascending" style="width: 276.337px;">Product</th><th class="text-end min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="SKU: activate to sort column ascending" style="width: 139.938px;">SKU</th><th class="text-end min-w-70px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Qty: activate to sort column ascending" style="width: 132.038px;">Qty</th><th class="text-end min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Price: activate to sort column ascending" style="width: 139.938px;">Price</th><th class="text-end min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Rating: activate to sort column ascending" style="width: 139.938px;">Rating</th><th class="text-end min-w-100px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 139.938px;">Status</th><th class="text-end min-w-70px sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 129.375px;">Actions</th></tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                        <!--begin::Table body-->
                        ...
                        <tr class="odd">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <!--begin::Thumbnail-->
                                        <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                            <span class="symbol-label" style="background-image:url(assets/media//stock/ecommerce/1.gif);"></span>
                                        </a>
                                        <!--end::Thumbnail-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 1</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="menu-link px-3">Edit</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 2</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">02645008</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 3</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">01404008</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 4</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">02639003</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <!--begin::Price=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder text-dark">$240.00</span>
                                </td>
                                <!--end::Price=-->
                                <!--begin::Rating-->
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 5</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">04147003</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <!--begin::Price=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder text-dark">$77.00</span>
                                </td>
                                <!--end::Price=-->
                                <!--begin::Rating-->
                                <td class="text-end pe-0" data-order="rating-3">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 6</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">03438003</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                <td class="text-end pe-0" data-order="26">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 7</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">01617005</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <!--begin::Price=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder text-dark">$67.00</span>
                                </td>
                                <!--end::Price=-->
                                <!--begin::Rating-->
                                <td class="text-end pe-0" data-order="rating-4">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 8</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">04643008</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                <td class="text-end pe-0" data-order="5">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 9</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">01724008</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
                                ...
                                <!--begin::Price=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder text-dark">$143.00</span>
                                </td>
                                <!--end::Price=-->
                                <!--begin::Rating-->
                                <td class="text-end pe-0" data-order="rating-3">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a href="../../demo17/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bolder" data-kt-ecommerce-product-filter="product_name">Product 10</a>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                </td>
                                ...
                                <!--begin::SKU=-->
                                <td class="text-end pe-0">
                                    <span class="fw-bolder">02330005</span>
                                </td>
                                <!--end::SKU=-->
                                <!--begin::Qty=-->
